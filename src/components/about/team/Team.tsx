    ...
    <section id="team" className="py-20 px-6 bg-gradient-to-b from-gray-900 to-black">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6">Meet Our <span className="text-[#e6002e]">Team</span></h2>
          ...
          {teamMembers.map((member, index) => (
            <Card key={index} className="bg-gradient-to-b from-gray-900/30 to-black/30 border-gray-800 hover:border-[#e6002e]/50 hover:shadow-[0_0_30px_rgba(230,0,46,0.2)] transition-all duration-300 group cursor-pointer">
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-[#e6002e] font-semibold">{member.position}</CardDescription>
              </CardHeader>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1 mb-3">
                    {member.expertise.map((skill, skillIndex) => (
                      <Badge key={skillIndex} variant="outline" className="text-xs text-gray-400 border-gray-600">
                        {skill}
                      </Badge>
                    ))}
                  </div>
